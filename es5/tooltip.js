(function (global, factory) {
	if (typeof define === 'function' && define.amd) {
		define(['exports', 'module', './lib/utils', 'get-style-property/get-style-property'], factory);
	...
	var Tooltip = (function () {
		function Tooltip(target) {
			...
			this.target = _libUtils.isElement(target) ? target : qS(target);
